...
if grouped.empty:
    ...
    svg_sys  = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="opacity:0.8;"><rect x="2" y="3" width="20" height="18" rx="4" ry="4"></rect><text x="12" y="16.5" text-anchor="middle" font-family="\'Inter\', sans-serif" font-size="13" font-weight="bold" fill="currentColor" stroke="none">ID</text></svg>'
